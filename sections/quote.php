                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="content">
                                    ...
                                    <form action="" method="post" class="wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" style="visibility: hidden; animation-duration: 1s; animation-delay: 0.5s; animation-name: none;">
                                        <div class="row">
